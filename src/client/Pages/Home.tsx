...
const Requirements: TitledContentFC = ({
  Container,
}) => (
  <Container>
    <p>
...
sections.push({
  title: 'Cahier des charges technique du site',
  anchor: 'cahier-des-charges',
  Content: Requirements,
});

const OpenSource: TitledContentFC = ({
  Container,
}) => (
  <Container>
    <p>
...
sections.push({
  title: (<>Un site <NoWrap>open-source</NoWrap> et en français</>),
  anchor: 'open-source',
  Content: OpenSource,
});
